...
class GrovsSingletonTest {
    ...
    fun `resetGrovsSingleton clears openedLinkDetails leaked by a previous test`() {
        ...
        getGrovsInstance().openedLinkDetails = leaked
        assertNotNullWithContext(
            Grovs.openedLinkDetails,
            "openedLinkDetails",
            "after directly setting openedLinkDetails to simulate a leak from a prior test"
        )
